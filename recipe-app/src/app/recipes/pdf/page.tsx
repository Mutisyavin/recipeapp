...
import { fetchRecipesFromAPI } from "../../../utils/recipeApi";
...
export default function PDFRecipesPage() {
  ...
  useEffect(() => {
    async function loadPDFRecipes() {
      try {
        setLoading(true);
        console.log("Fetching PDF recipes from API...");
        
        const pdfRecipes = await fetchRecipesFromAPI();
        console.log(`Loaded ${pdfRecipes.length} recipes from API`);
        
        setRecipes(pdfRecipes);
        setError(null);
      } catch (err: any) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-6">Recipes automatically extracted from your PDF cookbook</p>
        </div>
        ...
        {loading && (
          <div className="flex justify-center items-center p-8">
            ...
            <p className="ml-4">Loading recipes from PDFs...</p>
          </div>
        )}
                  ...
                  <div key={recipe.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition duration-300">
                    <div className="relative h-48 w-full bg-gray-200">
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-green-200 to-green-400 flex items-center justify-center">
                        <span className="text-4xl">{recipe.title.charAt(0)}</span>
                        {recipe.source && (
